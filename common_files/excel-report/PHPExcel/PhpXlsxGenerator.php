...
class PhpXlsxGenerator
{
    ...
    public function __construct()
    {
        $this->subject = '';
        $this->title = '';
        $this->author = 'PHP Dev <nalineesekar18@gmail.com>';
        $this->company = 'PHP Dev <nalineesekar18@gmail.com>';
        $this->manager = 'PHP Dev <nalineesekar18@gmail.com>';
        $this->description = '';
        $this->keywords = '';
        $this->category = '';
        $this->lastModifiedBy = 'PHP Dev <nalineesekar18@gmail.com>';
