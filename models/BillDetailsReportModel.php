...
class BillDetailsReportModel{
  ...
  if(preg_match('/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i',$useragent)||preg_match('/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i',substr($useragent,0,4))){
    ...
    $mobile='false';
      ...
      $privilege_city=implode(',', array_filter($city_list));
  
       if($privilege[0]['vendor']==1){
       	$vendor='ve.va_transporter_id='.$privilege[0]['trans_vendor_id'].'';
       }
       else{
       	$vendor='(b.client_arrival IN ('.$privilege_city.') or b.client_departure IN ('.$privilege_city.'))';
       ...
       $where='b.end_to BETWEEN  "'.date('Y-m-d',strtotime($fromStr)).'" AND "'.date('Y-m-d',strtotime($toStr)).'" and (ve.purchaserate_added_date LIKE "%0000-00-00 00:00:00%" or(ve.purchase_rate_approval_status=0 and ve.purchaserate_added_date!="0000-00-00 00:00:00") or (ve.purchase_rate_approval_status=1 and ve.approval_status_adjust=0) or (ve.approval_status_adjust=1 and ve.paid_status_bill_allotment=0))';
        ...
        else if((isset($_POST['type'])&&$_POST['type']==3)||$paiddd==1)
        {
      ...
      { $j=$individual_remaining=$sum_tripadvance=$tds_trip= 0;
       $toclosevaidloop=count($valuesa);
        ...
        if($vv==1){
          ...
          $s.='<td style="width: 7% !important"><span class="asr">BH Ref No</span> <span class="cllr">'.$valiee[0]['ref_no'].'</span><br>';
             if($_POST['type']==1||$_POST['type']==2){
                if($privilege[0]['vendor']==1){
                  if($valiee[0]['trip_went_not']!=2){
                   ...
                   $s.='<span class="asr">Travel Date</span><span class="cllr">A:'.date('d/m/Y',strtotime($valiee[0]['start_from'])).'</span><br><span class="cllr">D:'.date('d/m/Y',strtotime($valiee[0]['end_to'])).'</span><br>';
                }
              ...
              if($privilege[0]['vendor']==0){
                  $s.='<span class="asr">Transporter</span> <span class="cllr">'.$valiee[0]['transporter_name'].'</span><br>';
                }
          ...
          $s.='<td style="width: 7% !important">'.$valuesa[0]['client_name'].'</td>';
            if($privilege[0]['vendor']==0){
          $s.='<td style="width: 7% !important">A:'.date('d/m/Y',strtotime($valuesa[0]['start_from'])).'<br>D'.date('d/m/Y',strtotime($valuesa[0]['end_to'])).'</td>';
          }
          $s.="<td style='width: 7% !important'>".$valuesa[0]['client_arrival_name']."</td>";
               if($privilege[0]['vendor']==0){
            $s.='<td style="width: 3% !important" class="purchaserateupdate'.$valuesa[0]['id_client'].'">'.$purchase_total.'</td>';
          }
       ...
       //main loop key>Vehicle Allotemnt id
        ...
        if($j==0)
        {
         $total=0;
          $s.='<tr>';
            if($privilege[0]['vendor']==0){
          $s.='<td style="width: 7% !important;">'.$valuesa[0]['transporter_name'].'</td>';
        }
   ...
   $individual_remaining=$valuesa[0]['purchase_rate_shared']-($sum_tripadvance+round($tds_trip)+$valuesa[0]['received_amount']);
    ...
    //        if($valuesa[0]['purchase_rate_approval_status']==1){
				// 		$s.="<td style='width: 11% !important' ><div class='show_query'><span class='label label-warning fl' style='color:#108510;font-weight: bold;background:transparent;'>APPROVED<div class='show_me'>".$valuesa[0]['remark_adjust_allotment']."</div> </span></div></td>";

				// 	}
				// 	else if($valuesa[0]['purchase_rate_approval_status']==0 and $valuesa[0]['purchaserate_added_date']!="0000-00-00 00:00:00"){
				// 		$s.="<td style='width: 11% !important' ><span class='label color_field' style='color:#851010;font-weight: bold;'>PENDING</span></td>";

				// 	}
					
				// else {
				// 	$s.="<td style='width: 11% !important' >-</td>";
           ...
           if($count==0){
             ...
             $s.="<td  style='width: 7% !important' class='adjust_amount_update".$valuesa[0]['id_client']."'>".$total_remaining_amt."</td>";
           }
           else{
            $s.="<td style='width: 7% !important' ></td>";
           }
       }
        ...
        if($valuesa[0]['paid_status_bill_allotment']==1){
            ...
            $s.="<td style='width: 8% !important'><span class='label color_field' style='color:#851010;font-weight: bold;'>Not Submitted</span></td>";
              }
            ...
            $s.="<td style='width: 8% !important'><span class='label color_field' style='color:#851010;font-weight: bold;white-space: normal;'>Awaiting for verify</span></td>";
         }
         elseif($valuesa[0]['purchase_rate_approval_status']==0 and $valuesa[0]['purchaserate_added_date']!="0000-00-00 00:00:00" and $valuesa[0]['purchaserateVerified']==1){
            $s.="<td style='width: 8% !important'><span class='label color_field' style='color:#851010;font-weight: bold;white-space: normal;'>Awaiting for approval</span></td>";
         }
         elseif($valuesa[0]['purchase_rate_approval_status']==1 and $valuesa[0]['approval_status_adjust']==0){
            $s.="<td style='width: 8% !important'><span class='label color_field' style='color:#851010;font-weight: bold;white-space: normal;'>Awaiting for payment</span></td>";
         }
         elseif($valuesa[0]['approval_status_adjust']==1 and $valuesa[0]['paid_status_bill_allotment']==0){
            $s.="<td style='width: 8% !important'><span class='label color_field' style='color:#851010;font-weight: bold;'>Awaiting for payment</span></td>";
         }
